 ...
 * 
 */
@WebServiceClient(name = "SayHiServiceImpService", targetNamespace = "http://impl.service.css.com/", wsdlLocation = "http://localhost:8080/service/sayHi?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHISERVICEIMPSERVICE_QNAME = new QName("http://impl.service.css.com/", "SayHiServiceImpService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/service/sayHi?wsdl");
    ...
    public SayHiService getSayHiServiceImpPort() {
        return super.getPort(new QName("http://impl.service.css.com/", "SayHiServiceImpPort"), SayHiService.class);
    }
    ...
    public SayHiService getSayHiServiceImpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.css.com/", "SayHiServiceImpPort"), SayHiService.class, features);
    }
